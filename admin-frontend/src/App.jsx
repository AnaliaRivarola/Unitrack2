...
import { EditarTransporte } from "./views/EditarTransporte"; // Importa el componente EditarTransporte
import './App.css';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin/editar-transporte/:id" element={<EditarTransporte />} /> {/* Nueva ruta */}
      </Routes>
    </Router>
  );
}
